...
| `org.openadam.raster.prepare@0.1.0` | development pilot | not published here | Catalog and maintainer-local integration only |
| `org.openadam.raster.verify@0.1.0` | development pilot | not published here | Catalog and maintainer-local integration only |
| `org.openadam.projective.transform@0.1.0` | development pilot | not published here | Catalog and maintainer-local integration only |
